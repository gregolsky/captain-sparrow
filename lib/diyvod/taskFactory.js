...
var 
    ...
    EpisodesProvider = require('./tv/trakt/episodesProvider'),
    TraktClient = require('./tv/trakt/client'),
...
function resolveTorrentSearch(settings, fileManager, logger) {
  ...
  return new TorrentSearch(settings, kickassTorrentSearch, fileDownloader);
}
