...
function getEpisodes() {
  var self = this;
  var since = settings.tv.episodesSince || self.getYesterdayDate();
  var days = (moment(this.dateService.currentDate()) - moment(since)).days();

  self.client.userCalendarShows(self.settings.trakt.username, since, days)
  .then(function(data){
