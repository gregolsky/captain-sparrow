...
var TransmissionClient = include('transmission'),
    ...
    TorrentApiOrg = include('torrentProvider/torrentApiOrg'),
    TorrentApiOrgProvider = include('torrentProvider/torrentApiOrgProvider');
...
function resolveTvShowsDownload (settings, fileManager, logger) {
    ...
    .then(function () {
        ...
        var torrentClient = new TorrentApiOrg();
        var torrentSearch = new TorrentApiOrgProvider(torrentClient);
